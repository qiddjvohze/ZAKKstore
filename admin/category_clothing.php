...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php include 'includes/category_modal_clothing.php'; // Contains modals for add/edit/delete ?>
...
function getRow(id){
  $.ajax({
    type: 'POST',
    url: 'category_row_clothing.php', // The PHP script that fetches category data by ID
    data: {id:id},
    dataType: 'json',
