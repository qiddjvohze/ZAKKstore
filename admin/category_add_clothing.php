<?php
    ...
    */
    ...
    if(isset($_POST['add'])){
        ...
        $stmt_check_name = $conn->prepare("SELECT COUNT(*) AS numrows FROM category1 WHERE name=:name");
        ...
        if($row_name['numrows'] > 0){
            ...
            try{
                ...
                $stmt_insert = $conn->prepare("INSERT INTO category1 (name, cat_slug) VALUES (:name, :cat_slug)");
    ...
    header('location: category_clothing.php');
